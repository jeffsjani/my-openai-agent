...
// Version: agent-stage-background-v2026-05-13-11-rewrite-safe-block
//
// Purpose:
// - Receives one stage payload from BuildShip /story-run/execute-stage.
// - Runs exactly one stage.
// - Posts a flat stage-complete callback to BuildShip /story-run/stage-complete.
// - Supports intake deterministically.
// - Supports draft / Node 3 via a compact OpenAI Responses call in short-mode.
// - Safely blocks rewrite/polish/finalize before heavy parsing so unsupported stages do not 500.
//
...
// - DRAFT_STAGE_SHORT_MODE=true|false (default true)
// - DRAFT_STAGE_TARGET_WORD_COUNT=900
// - DRAFT_STAGE_MAX_OUTPUT_TOKENS=12000
// - DRAFT_STAGE_TIMEOUT_MS=480000
// - OPENAI_DRAFT_MODEL=gpt-5.5

const AGENT_BACKGROUND_STAGE_VERSION =
  "agent-stage-background-v2026-05-13-11-rewrite-safe-block";
