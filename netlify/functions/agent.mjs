...
const NullableStringOrInt = z.union([z.string(), z.number().int(), z.null()]);
...
const Node1IntakeScopeLockCanonBasisAndStoreRoutingSchema = z.object({ story_run_id: NullableString, project_id: NullableString, chapter_worker_version: NullableString, chapter_context: ChapterContextSchema, run_config: RunConfigSchema, status: z.enum(["ready", "needs_input", "blocked"]), requested_operation: z.enum(["draft", "evaluate", "rewrite", "polish", "format"]), resolved_scope: z.string(), target_units_requested: z.array(z.string()), canon_basis: z.enum(["master_story_bible", "approved_draft", "target_text_only"]), active_bible_sections: z.array(z.any()), drafting_bible_stack: z.object({ active_every_time: z.array(z.object({ section_number: NullableStringOrInt, section_name: z.string(), packet_name: z.string(), drafting_role: z.string() })) }), downstream_store_requests: z.object({ drafting_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["DraftingHouseRules.pdf"]), required_for_operations: z.array(z.enum(["draft", "evaluate", "rewrite"])), priority_rules: z.array(z.enum(["12", "13", "13A", "22", "23"])), structure_lock_policy: z.enum(["not_required"]) }), polish_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["PolishHouseRules.pdf"]), required_for_operations: z.array(z.enum(["polish"])), priority_rules: z.array(z.string()), structure_lock_policy: z.enum(["required"]) }) }), missing_required_inputs: z.array(z.string()), blocked_reasons: z.array(z.string()), next_node: z.enum(["N2_Unit_Contract_Builder", ""]) });
const Node2UnitContractBuilderSchema = z.object({ story_run_id: NullableString, project_id: NullableString, chapter_worker_version: NullableString, chapter_context: ChapterContextSchema, run_config: RunConfigSchema, status: z.enum(["ready", "needs_input", "blocked"]), requested_operation: z.enum(["draft", "evaluate", "rewrite", "polish", "format"]), resolved_scope: z.string(), target_units_requested: z.array(z.string()), canon_basis: z.enum(["master_story_bible", "approved_draft", "target_text_only"]), active_bible_sections: z.array(z.any()), drafting_bible_stack: z.object({ active_every_time: z.array(z.object({ section_number: NullableStringOrInt, section_name: z.string(), packet_name: z.string(), drafting_role: z.string() })) }), style_packet: z.object({ source_section_number: NullableStringOrInt, narrative_mandate: z.string(), prose_texture: z.string(), opening_propulsion: z.string(), narrative_rhythm: z.string(), descriptive_priority: z.string(), object_engine_rule: z.string(), emotional_handling: z.string(), pleasure_rule: z.string(), emotion_inside_motion: z.string(), suspense_rule: z.string(), political_handling: z.string(), action_handling: z.string(), dialogue_relation: z.string(), pov_discipline: z.string(), atmosphere_rule: z.string(), ending_rule: z.string(), suspense_sequence_pass_criteria: z.array(z.string()), suspense_sequence_failure_signs: z.array(z.string()), forbidden_style_failures: z.array(z.string()), style_shorthand: z.string() }), dialogue_voice_packet: z.object({ source_section_number: NullableStringOrInt, dialogue_mandate: z.string(), voice_differentiation_rules: z.array(z.string()), subtext_rules: z.array(z.string()), compression_rules: z.array(z.string()), interruption_and_silence_rules: z.array(z.string()), flirtation_and_desire_rules: z.array(z.string()), institutional_speech_rules: z.array(z.string()), voice_forbidden_failures: z.array(z.string()), dialogue_voice_shorthand: z.string() }), locked_draft_priorities_packet: z.object({ source_section_number: NullableStringOrInt, locked_draft_mandate: z.string(), nonnegotiable_priorities: z.array(z.string()), do_not_change: z.array(z.string()), escalation_priorities: z.array(z.string()), relationship_lock_points: z.array(z.string()), object_and_motif_lock_points: z.array(z.string()), ending_and_payoff_lock_points: z.array(z.string()), locked_priorities_shorthand: z.string() }), character_constellation_packet: z.object({ source_section_number: NullableStringOrInt, constellation_mandate: z.string(), central_pairing: z.string(), major_characters: z.array(z.object({ name: z.string(), role: z.string(), function: z.string(), relation_to_pov: z.string() })), relationship_pressure_lines: z.array(z.string()), attraction_conflict_axes: z.array(z.string()), trust_fault_lines: z.array(z.string()), constellation_shorthand: z.string() }), structural_spine_packet: z.object({ source_section_number: NullableStringOrInt, current_unit_spine_function: z.string(), upstream_dependencies: z.array(z.string()), downstream_setup_payoffs: z.array(z.string()), escalation_logic: z.array(z.string()), spine_shorthand: z.string() }), setpiece_symbol_architecture_packet: z.object({ source_section_number: NullableStringOrInt, setpiece_mandate: z.string(), chapter_relevant_setpieces: z.array(z.string()), object_symbol_rules: z.array(z.string()), visual_escalation_cues: z.array(z.string()), setpiece_failure_signs: z.array(z.string()), architecture_shorthand: z.string() }), world_setting_palette_packet: z.object({ source_section_number: NullableStringOrInt, setting_palette_rules: z.array(z.string()), city_specific_texture_rules: z.array(z.string()), environmental_pressure_cues: z.array(z.string()), institutional_surface_rules: z.array(z.string()), palette_shorthand: z.string() }), thematic_moral_architecture_packet: z.object({ source_section_number: NullableStringOrInt, thematic_mandate: z.string(), central_thematic_questions: z.array(z.string()), moral_pressure_lines: z.array(z.string()), private_public_cost_rules: z.array(z.string()), contradiction_and_complicity_rules: z.array(z.string()), thematic_shorthand: z.string() }), signature_verbal_deployment_packet: z.object({ source_section_number: NullableStringOrInt, signature_language_rules: z.array(z.string()), recurring_phrase_motifs: z.array(z.string()), metaphor_and_comparison_rules: z.array(z.string()), verbal_do_not_use: z.array(z.string()), signature_shorthand: z.string() }), research_authenticity_packet: z.object({ source_section_number: NullableStringOrInt, authenticity_mandate: z.string(), procedural_truth_rules: z.array(z.string()), terminology_and_register_rules: z.array(z.string()), domain_specific_constraints: z.array(z.string()), realism_do_not_fake: z.array(z.string()), authenticity_shorthand: z.string() }), prestige_quality_alignment_packet: z.object({ source_section_number: NullableStringOrInt, prestige_mandate: z.string(), quality_benchmarks: z.array(z.string()), anti_generic_failures: z.array(z.string()), audience_promise_rules: z.array(z.string()), prestige_shorthand: z.string() }), unit_contracts: z.array(z.object({ source_section_number: NullableStringOrInt, movement_label: z.string(), movement_approximate_length: NullableStringOrInt, unit_label: z.string(), target_word_count: NullableStringOrInt, pov: z.string(), setting: z.string(), objective: z.string(), conflict: z.string(), reversal: z.string(), reveal: z.string(), carry_forward: z.string(), ending_hook: z.string(), drafting_beats: z.array(z.string()) })), downstream_store_requests: z.object({ drafting_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["DraftingHouseRules.pdf"]), required_for_operations: z.array(z.enum(["draft", "evaluate", "rewrite"])), priority_rules: z.array(z.enum(["12", "13", "13A", "22", "23"])), structure_lock_policy: z.enum(["not_required"]) }), polish_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["PolishHouseRules.pdf"]), required_for_operations: z.array(z.enum(["polish"])), priority_rules: z.array(z.string()), structure_lock_policy: z.enum(["required"]) }) }), missing_required_inputs: z.array(z.string()), blocked_reasons: z.array(z.string()), next_node: z.enum(["N3_Chapter_Drafter", ""]) });
const Node3ChapterDrafterSchema = z.object({ story_run_id: NullableString, project_id: NullableString, chapter_worker_version: NullableString, chapter_context: ChapterContextSchema, run_config: RunConfigSchema, status: z.enum(["ready", "needs_input", "blocked"]), requested_operation: z.enum(["draft"]), resolved_scope: z.string(), target_units_requested: z.array(z.string()), canon_basis: z.enum(["master_story_bible", "approved_draft", "target_text_only"]), active_bible_sections: z.array(z.any()), drafting_bible_stack: z.object({ active_every_time: z.array(z.object({ section_number: NullableStringOrInt, section_name: z.string(), packet_name: z.string(), drafting_role: z.string() })) }), style_packet: z.object({ source_section_number: NullableStringOrInt, narrative_mandate: z.string(), prose_texture: z.string(), opening_propulsion: z.string(), narrative_rhythm: z.string(), descriptive_priority: z.string(), object_engine_rule: z.string(), emotional_handling: z.string(), pleasure_rule: z.string(), emotion_inside_motion: z.string(), suspense_rule: z.string(), political_handling: z.string(), action_handling: z.string(), dialogue_relation: z.string(), pov_discipline: z.string(), atmosphere_rule: z.string(), ending_rule: z.string(), suspense_sequence_pass_criteria: z.array(z.string()), suspense_sequence_failure_signs: z.array(z.string()), forbidden_style_failures: z.array(z.string()), style_shorthand: z.string() }), dialogue_voice_packet: z.object({ source_section_number: NullableStringOrInt, dialogue_mandate: z.string(), voice_differentiation_rules: z.array(z.string()), subtext_rules: z.array(z.string()), compression_rules: z.array(z.string()), interruption_and_silence_rules: z.array(z.string()), flirtation_and_desire_rules: z.array(z.string()), institutional_speech_rules: z.array(z.string()), voice_forbidden_failures: z.array(z.string()), dialogue_voice_shorthand: z.string() }), locked_draft_priorities_packet: z.object({ source_section_number: NullableStringOrInt, locked_draft_mandate: z.string(), nonnegotiable_priorities: z.array(z.string()), do_not_change: z.array(z.string()), escalation_priorities: z.array(z.string()), relationship_lock_points: z.array(z.string()), object_and_motif_lock_points: z.array(z.string()), ending_and_payoff_lock_points: z.array(z.string()), locked_priorities_shorthand: z.string() }), character_constellation_packet: z.object({ source_section_number: NullableStringOrInt, constellation_mandate: z.string(), central_pairing: z.string(), major_characters: z.array(z.object({ name: z.string(), role: z.string(), function: z.string(), relation_to_pov: z.string() })), relationship_pressure_lines: z.array(z.string()), attraction_conflict_axes: z.array(z.string()), trust_fault_lines: z.array(z.string()), constellation_shorthand: z.string() }), structural_spine_packet: z.object({ source_section_number: NullableStringOrInt, current_unit_spine_function: z.string(), upstream_dependencies: z.array(z.string()), downstream_setup_payoffs: z.array(z.string()), escalation_logic: z.array(z.string()), spine_shorthand: z.string() }), setpiece_symbol_architecture_packet: z.object({ source_section_number: NullableStringOrInt, setpiece_mandate: z.string(), chapter_relevant_setpieces: z.array(z.string()), object_symbol_rules: z.array(z.string()), visual_escalation_cues: z.array(z.string()), setpiece_failure_signs: z.array(z.string()), architecture_shorthand: z.string() }), world_setting_palette_packet: z.object({ source_section_number: NullableStringOrInt, setting_palette_rules: z.array(z.string()), city_specific_texture_rules: z.array(z.string()), environmental_pressure_cues: z.array(z.string()), institutional_surface_rules: z.array(z.string()), palette_shorthand: z.string() }), thematic_moral_architecture_packet: z.object({ source_section_number: NullableStringOrInt, thematic_mandate: z.string(), central_thematic_questions: z.array(z.string()), moral_pressure_lines: z.array(z.string()), private_public_cost_rules: z.array(z.string()), contradiction_and_complicity_rules: z.array(z.string()), thematic_shorthand: z.string() }), signature_verbal_deployment_packet: z.object({ source_section_number: NullableStringOrInt, signature_language_rules: z.array(z.string()), recurring_phrase_motifs: z.array(z.string()), metaphor_and_comparison_rules: z.array(z.string()), verbal_do_not_use: z.array(z.string()), signature_shorthand: z.string() }), research_authenticity_packet: z.object({ source_section_number: NullableStringOrInt, authenticity_mandate: z.string(), procedural_truth_rules: z.array(z.string()), terminology_and_register_rules: z.array(z.string()), domain_specific_constraints: z.array(z.string()), realism_do_not_fake: z.array(z.string()), authenticity_shorthand: z.string() }), prestige_quality_alignment_packet: z.object({ source_section_number: NullableStringOrInt, prestige_mandate: z.string(), quality_benchmarks: z.array(z.string()), anti_generic_failures: z.array(z.string()), audience_promise_rules: z.array(z.string()), prestige_shorthand: z.string() }), unit_contracts: z.array(z.object({ source_section_number: NullableStringOrInt, movement_label: z.string(), movement_approximate_length: NullableStringOrInt, unit_label: z.string(), target_word_count: NullableStringOrInt, pov: z.string(), setting: z.string(), objective: z.string(), conflict: z.string(), reversal: z.string(), reveal: z.string(), carry_forward: z.string(), ending_hook: z.string(), drafting_beats: z.array(z.string()) })), store_packet_status: z.enum(["preserved", "rebuilt"]), drafted_units: z.array(z.object({ unit_label: z.string(), chapter_heading: z.string(), drafted_text: z.string(), ending_condition: z.string(), carry_forward_summary: z.string() })), downstream_store_requests: z.object({ drafting_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["DraftingHouseRules.pdf"]), required_for_operations: z.array(z.enum(["draft", "evaluate", "rewrite"])), priority_rules: z.array(z.enum(["12", "13", "13A", "22", "23"])), structure_lock_policy: z.enum(["not_required"]) }), polish_rules_request: z.object({ store_name: z.enum(["VeritasStudioStore"]), document_name: z.enum(["PolishHouseRules.pdf"]), required_for_operations: z.array(z.enum(["polish"])), priority_rules: z.array(z.string()), structure_lock_policy: z.enum(["required"]) }) }), missing_required_inputs: z.array(z.string()), blocked_reasons: z.array(z.string()), next_node: z.enum(["N4A_Upstream_Draft_Gate", ""]) });
const Node4bEnhancementEvaluatorSchema = z.object({ story_run_id: NullableString, project_id: NullableString, chapter_worker_version: NullableString, chapter_context: ChapterContextSchema, run_config: RunConfigSchema, status: z.enum(["ready", "blocked"]), requested_operation: z.enum(["draft", "rewrite"]), resolved_scope: z.string(), target_units_requested: z.array(z.string()), upstream_source_node: z.enum(["N3_Chapter_Drafter", "N5_Chapter_Rewriter", ""]), matching_node2_status: z.enum(["present", "missing"]), enhancement_cycle_number: NullableInt, max_enhancement_cycles: NullableInt, cycles_remaining_after_rewrite: NullableInt, per_unit_enhancement_packets: z.array(z.object({ unit_label: z.string(), contract_fidelity_score: NullableInt, drafting_rules_compliance_score: NullableInt, chapter_drive_score: NullableInt, kindle_readability_score: NullableInt, suspense_emotional_voltage_score: NullableInt, preserve: z.array(z.string()), clarify: z.array(z.string()), cut_or_reduce: z.array(z.string()), strengthen: z.array(z.string()), add_or_sharpen: z.array(z.string()), dialogue_upgrades: z.array(z.string()), pov_emotional_access_upgrades: z.array(z.string()), suspense_thriller_pressure_upgrades: z.array(z.string()), pacing_bingeability_upgrades: z.array(z.string()), paragraphing_kindle_readability_upgrades: z.array(z.string()), ending_forward_pressure_upgrades: z.array(z.string()), ready_to_paste_rewrite_brief: z.string() })), cross_chapter_sequence_instructions: z.string(), rewrite_brief: z.string(), blocked_reasons: z.array(z.string()), next_node: z.enum(["N5_Chapter_Rewriter", ""]) });
...
const Node7PolishEvaluatorSchema = z.object({ story_run_id: NullableString, project_id: NullableString, chapter_worker_version: NullableString, chapter_context: ChapterContextSchema, run_config: RunConfigSchema, status: z.enum(["ready", "blocked"]), requested_operation: z.enum(["polish"]), resolved_scope: z.string(), target_units_requested: z.array(z.string()), configured_max_polish_cycles: NullableInt, upstream_source_node: z.enum(["N5_Chapter_Rewriter", "N8_Polish_Rewriter", ""]), polish_cycle_number: NullableInt, max_polish_cycles: NullableInt, cycles_remaining_after_polish: NullableInt, per_unit_polish_packets: z.array(z.object({ unit_label: z.string(), polish_readiness_score: NullableInt, dialogue_naturalism_score: NullableInt, kindle_readability_score: NullableInt, paragraph_density_score: NullableInt, voice_preservation_score: NullableInt, preserve: z.array(z.string()), tighten: z.array(z.string()), smooth_or_rephrase: z.array(z.string()), punctuation_cleanup: z.array(z.string()), dialogue_self_check_repairs: z.array(z.string()), character_voice_preservation: z.array(z.string()), paragraph_density_cleanup: z.array(z.string()), line_break_cleanup: z.array(z.string()), formatting_cleanup: z.array(z.string()), continuity_microfixes: z.array(z.string()), final_surface_cleanup: z.array(z.string()), ready_to_paste_polish_brief: z.string() })), cross_chapter_polish_instructions: z.string(), polish_brief: z.string(), blocked_reasons: z.array(z.string()), next_node: z.enum(["N8_Polish_Rewriter", ""]) });
